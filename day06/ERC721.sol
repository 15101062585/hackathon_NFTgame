...
contract BaseERC721 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            msg.sender == owner /**code*/ ||isApprovedForAll(owner, msg.sender),
    ...
    function _transfer(address from, address to, uint256 tokenId) internal {
        require(
           ownerOf(tokenId) == from/**code*/,
            "ERC721: transfer from incorrect owner"
        );

        require(to != address(0)/**code*/, "ERC721: transfer to the zero address");
